  ...
  async getCallJob(job_id: string): Promise<CallJob | null> {
    ...
    return {
      ...
      attempts: attempts.map((a: Record<string, unknown>) => ({
        ...
        generated_script_source: a.generated_script_source as "openai" | "fallback" | "elevenlabs_agent" | undefined,
        voice_path: a.voice_path as "elevenlabs_play" | "twilio_say" | "elevenlabs_agent" | undefined,
